...
export const catalogProducts: CatalogProduct[] = [
  {
    ...
    description: "Personalized 20 x 4 cm graduation water bottle label for party bottles.",
    widthCm: 20,
    heightCm: 4,
    shape: "rectangle",
    isActive: true,
  ...
  },
  {
    ...
    categorySlug: "graduation",
    description: "Personalized 4 cm round graduation sticker for juice bottles and party favors.",
    widthCm: 4,
    heightCm: 4,
    diameterCm: 4,
    shape: "circle",
